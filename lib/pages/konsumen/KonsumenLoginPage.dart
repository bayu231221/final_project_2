...
class KonsumenLoginPage extends StatelessWidget {
  static const routeName = '/konsumenlogin';

  KonsumenLoginPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
          ...
          if (userSnapshot.exists) {
            ...
            if (role == 'konsumen') {
              ...
              Navigator.pushReplacementNamed(
                context,
                BerandaKonsumenPage.routeName,
              );
            }
          } else {
            await deleteUserData();
            Fluttertoast.showToast(
              msg: 'Akun tidak ditemukan atau bukan konsumen!',
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.BOTTOM,
            );
          }
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Login sebagai Konsumen'),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, KonsumenRegisterPage.routeName);
              },
              child: const Text(
